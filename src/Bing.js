...
function ready() {
    ...
    document.getElementById('check-btn').addEventListener('click', purchaseClicked)
}
...
//get data from localStorage and make the variables equal to that
//
function addToCartClicked(event) {
    ...
    var title = localStorage.getItem("ItemName")
    var price = localStorage.getItem("ItemPrice")
    var imageSrc = shopItem.getElementsByClassName('shop-item-image')[0].src
    addItemToCart(title, price, imageSrc)
    updateCartTotal()
    console.log("Bing Session: " + localStorage.getItem("items"))
}
            ...
            <section class="fakeShop">
                    ...
                    <div class="title">
                      Shopping Bag
                        ...
                        <div class="checkout">
                        <a href= "PaymentMenu"><button type="button" class="btn btn-success btn-lg" id="check-btn">Checkout</button></a>
                        </div>
                  </div>
