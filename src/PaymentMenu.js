...
import payment1 from "./components/img/mastercard.png";
import payment2 from "./components/img/visa.png";
      ...
      <div className="App">
        ...
        <section>
            <form class="needs-validation" novalidate>
              ...
              <a href="#" img src= {payment1} alt ="Mastercard"/>
              <a href="#" img src= {payment2} alt ="Visa"/>
              </div>
        </section>
