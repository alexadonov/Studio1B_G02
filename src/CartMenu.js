...
export default class CartMenu extends Component {
  render() {
    ...
    function addToCartClicked(event) {
        ...
        localStorage.setItem("ItemName", obj.title)
        localStorage.setItem("ItemPrice", obj.price)
        ...
        <Router>
            ...
            <div class ="container">
              <div class="card">
                <div class="card-block">
                  <h4 class="class-title">otge</h4>
                  <p class="card-text">Price:2323</p>
                  <a href = "#" data-name = "orange" data-price=".5" class="add-to-cart btn btn primary">add</a>
                </div>
              </div>
            </div>
            <section class="fakeShop">
                            <div class="shop-item">
                                <span class="shop-item-title">Album 1</span>
                                <img class="shop-item-image" src={"Images/Album 1.png"}/>
                                <div class="shop-item-details">
                                    <span class="shop-item-price">$1000.99</span>
            ...
            <div class="shopping-cart">
              ...
              <div class="item">
                ...
                <div class="buttons" id ="crossButton">
                ...
                <div class="quantity">
                  <button class="plus-btn" id ="Abtn" type="button" name="plusButton" onClick>
                    <img src={plusIcon} alt="plusIcon" />
                  </button>
                  <input type="text" id="qCounter" name="name" value = "1"/>
                  <button class="minus-btn" id ="Abtn" type="button" name="minusbutton" onClick>
              ...
              <div class="item">
                ...
                <div class="quantity">
                  ...
                  <input type="text" id="qCounter" name="name" value="1"/>
                  <button class="minus-btn" id ="Abtn" type="button" name="button" onClick>
                    <img src={minusIcon} alt="minusIcon" />
                  </button>
                </div>
              ...
              <div class="checkout">
              <a href= "PaymentMenu"><button type="button" class="btn btn-success btn-lg">Checkout</button></a>
              </div>
